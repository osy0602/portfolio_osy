...
const Services = () => {
    ...
    const isDesktop = useMediaQuery({minWidth: '48rem'}); //768
    useGSAP(() => {
            ...
            >
                <div className="flex items-center justify-between gap-4 font-light">
                    <div className="flex flex-col gap-6">
                        ...
                        <p className="text-xl leading-realaxed tracking-widest lg:text-2xl text-white/60 text-pretty">{service.description}</p>
